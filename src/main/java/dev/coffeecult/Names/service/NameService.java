...
public class NameService {
    ...
    public ResponseEntity<String> populateDefaultDB() {
        if (namesRepository.findAll().isEmpty()) {
            var names = Set.of(
        ...
        return new ResponseEntity<>("There are already some value in DB", HttpStatus.OK);
    }
}
